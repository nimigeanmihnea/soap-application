 ...
 * 
 */
@WebServiceClient(name = "LoginService", targetNamespace = "http://service/", wsdlLocation = "http://localhost:9000/login?wsdl")
    ...
    extends Service
{
    ...
    public Login getLoginPort() {
        return super.getPort(new QName("http://service/", "LoginPort"), Login.class);
    }
    ...
    public Login getLoginPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service/", "LoginPort"), Login.class, features);
    }
